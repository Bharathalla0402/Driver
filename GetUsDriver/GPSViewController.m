...
- (void)viewDidLoad {
    ...
    self.title=@"GPS";
     [self addBackButtonWithImageName:@"Untitled-1-2.png"];
    ...
    [self performSelector:@selector(NavigateButtonClicked1:) withObject:self afterDelay:0.1];
...
-(void)parseJSONRespon12:(NSData*)responseData
{
    NSError *err;
