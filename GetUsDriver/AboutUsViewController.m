...
-(void)buttontapp:(id)sender
{
    UIAlertView *alert=[[UIAlertView alloc] initWithTitle:@"Message" message:@"Yes,This is Correct" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    [alert show];
...
-(void)parseJSONResponse:(NSData*)responseData
{
  ...
  //  NSLog(@"*****AboutUs details ******* %@", responseJSON);
    ...
    else if([[NSString stringWithFormat:@"%@",status] isEqualToString:[NSString stringWithFormat:@"1"]])
    {
      ...
      //  [_ContentView loadHTMLString:urlString baseURL:nil];
    }
}
...
- (IBAction)feedbackclicked:(id)sender
{
  ...
  // NSString *stremailid = [urlString stringByTrimmingCharactersInSet:
    ...
    [_ContentView loadHTMLString:htmlString baseURL:nil];
 //   [_ContentView loadHTMLString:stremailid baseURL:nil];
