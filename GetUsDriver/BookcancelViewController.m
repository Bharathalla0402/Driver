...
- (void)viewDidLoad {
   ...
   [_btn1 setImage:[UIImage imageNamed:@"radio button selected_20-20.png"] forState:UIControlStateNormal];
    ...
    [_btn5 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
    [_btn6 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
    
   str=@"Auto mechanic problem";
}
- (IBAction)btnclicked:(UIButton*)sender
{
    ...
    else if (sender.tag==2)
    {
        ...
        [_btn6 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
         ...
         str=@"Get involve into an accident";
    ...
    else if (sender.tag==3)
    {
        ...
        str=@"Pull over by a police officer";
    }
    ...
    else if (sender.tag==5)
    {
        ...
        [_btn3 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
        [_btn4 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
        [_btn5 setImage:[UIImage imageNamed:@"radio button selected_20-20.png"] forState:UIControlStateNormal];
        [_btn6 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
        
        str=@"Customer decide to cancel ride";
    }
    else if (sender.tag==6)
    {
        ...
        [_btn4 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
        [_btn5 setImage:[UIImage imageNamed:@"radio button unselected_20-20.png"] forState:UIControlStateNormal];
        [_btn6 setImage:[UIImage imageNamed:@"radio button selected_20-20.png"] forState:UIControlStateNormal];
